...
<head>
  ...
  <meta content="" name="author" />
    ...
    <!-- PAGE LEVEL STYLES -->
    <link href="<?php echo Yii::app()->theme->baseUrl ?>/assets/css/layout2.css" rel="stylesheet" />
       <link href="<?php echo Yii::app()->theme->baseUrl ?>/assets/plugins/flot/examples/examples.css" rel="stylesheet" />
       <link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl ?>/assets/plugins/timeline/timeline.css" />
...
<body class="padTop53 " >
    ...
    <!-- PAGE LEVEL SCRIPTS -->
    <script src="<?php echo Yii::app()->theme->baseUrl ?>/assets/plugins/flot/jquery.flot.js"></script>
    <script src="<?php echo Yii::app()->theme->baseUrl ?>/assets/plugins/flot/jquery.flot.resize.js"></script>
    <script src="<?php echo Yii::app()->theme->baseUrl ?>/assets/plugins/flot/jquery.flot.time.js"></script>
     <script  src="<?php echo Yii::app()->theme->baseUrl ?>/assets/plugins/flot/jquery.flot.stack.js"></script>
    <script src="<?php echo Yii::app()->theme->baseUrl ?>/assets/js/for_index.js"></script>
