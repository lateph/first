...
$this->adminTitle = 'Galery Event #'.$model->id;
?>
            ...
            <div class="panel-body">
        			...
        			<p style="text-align:center">
        				<?php foreach ($model->galerys as $key => $value): ?>
							<a  class="gal" href="<?php echo LUpload::raw('EventGalery',$value->file); ?>" ><img src="<?php echo LUpload::thumbs('EventGalery',$value->file,'200x200'); ?>" alt="" /></a>
        				<?php endforeach ?>
		        	</p>
            </div>
        </div>
            ...
            <div class="panel-body">
            	<div class="form">
					<?php $form=$this->beginWidget('CActiveForm', array(
						...
						<?php echo $form->hiddenField($newGalery,'idEvent'); ?>
